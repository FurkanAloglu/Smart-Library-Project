package com.furkan.smart_library_backend.security;
...
public class JwtService {
    ...
    private static final long ACCESS_TOKEN_EXPIRATION = 1000 * 60 * 15; //15 dk
    ...
    private String buildToken(Map<String, Object> extraClaims, UserDetails userDetails, long expiration) {
        return Jwts.builder()
                ...
                .signWith(getSignInKey(), Jwts.SIG.HS256) // Güncel Syntax
                .compact();
    }
    ...
    private Claims extractAllClaims(String token) {
        return Jwts.parser()
                .verifyWith(getSignInKey()) // Güncel Syntax
                .build()
